...
- Displays the amount of mana expended each cast
...
- Account for other mana gains outside the MP5 rule (such as Blessing of Wisdom, etc.)
- Monitor/track Energy gains for rogues/druids
- Test thoroughly with all classes
